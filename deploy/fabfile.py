...
env.hosts = ['root@47.94.208.122:22']
env.password = '12345678'
env.key_filename = '~/.ssh/id_rsa'

# path on server
DEPLOY_DIR = '/var/www'
PROJECT_DIR = os.path.join(DEPLOY_DIR, 'TS_backend')
...
# path on local
PROJECT_LOCAL_DIR = 'TS_backend'

GITHUB_PATH = 'https://github.com/LaZzyMan/TS_backend'
